/* empabs.c - Xpert Employee Absentee Program*/
/*lint -library */
#ifndef WIN32
#define __NAM__ "empabs.lnx"
#endif
#ifdef WIN32
#define __NAM__ "empabs.exe"
#endif
#include <app.h>
#include <rdaglob.h>
#include <rdaflds.h>
...
extern void empabsm(short,void *);
static void doexit(MakeBrowseList *),okfunc(MakeBrowseList *,void *);
static void new_record(RDArsrc *,MakeBrowseList *);
char editable=TRUE;
MakeBrowseList *mbl_empabs=NULL;
MaintainMaster *MASTER=NULL;
void browse_empabs(RDArsrc *,RDATData *);

void browse_empabs(RDArsrc *mtnrsrc,RDATData *previous)
{
	...
	mbl_empabs=ADVPbrowse(MASTER->passkey->fileno,MASTER->passkey->keyno,mainrsrc,searchrsrc,
...
static void okfunc(MakeBrowseList *blist,void *targetkey)
{
	...
	{
		if(!run_func) empabsm(0,targetkey);
