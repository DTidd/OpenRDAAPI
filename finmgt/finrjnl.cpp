/* finrjnl.c - Receipt Journal Browse Program */
/*lint -library */
#ifndef WIN32
#define __NAM__ "finrjnl.lnx"
#endif
#ifdef WIN32
#define __NAM__ "finrjnl.exe"
#endif
#include <app.h>
#include <rdaglob.h>
#include <rdaflds.h>
...
extern void finrjnlm(short,void *);
static void doexit(MakeBrowseList *),okfunc(MakeBrowseList *,void *);
static void new_record(RDArsrc *,MakeBrowseList *);
short baccnum=(-1),eaccnum=(-1),raccnum=(-1);
MakeBrowseList *mbl_finrjnl=NULL;
void browse_finrjnl(RDArsrc *,mtnstruct *);
MaintainMaster *MASTER=NULL;

void browse_finrjnl(RDArsrc *mtnrsrc,mtnstruct *mtn)
{
	...
	mbl_finrjnl=ADVPbrowse(MASTER->passkey->fileno,MASTER->passkey->keyno,mainrsrc,
...
static void doexit(MakeBrowseList *blist)
{
	...
	if(mbl_finrjnl!=NULL) mbl_finrjnl=NULL;
}
