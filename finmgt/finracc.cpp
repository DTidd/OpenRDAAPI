/* finracc.c - Xpert Financial Management Revenue Account Browse Program */
/*lint -library */
#ifndef WIN32
#define __NAM__ "finracc.lnx"
#endif
#ifdef WIN32
#define __NAM__ "finracc.exe"
#endif
#include <app.h>
#include <rdaglob.h>
#include <rdaflds.h>
...
extern MakeBrowseList *mbl_finracc;
extern void finraccm(short,void *);
static void doexit(MakeBrowseList *),okfunc(MakeBrowseList *,void *);
static void new_record(RDArsrc *,MakeBrowseList *);
void browse_finracc(RDArsrc *,mtnstruct *);
MaintainMaster *MASTER=NULL;

void browse_finracc(RDArsrc *mtnrsrc,mtnstruct *mtn)
{
	...
	mbl_finracc=ADVPbrowse(MASTER->passkey->fileno,MASTER->passkey->keyno,mainrsrc,searchrsrc,
...
static void doexit(MakeBrowseList *blist)
{
	...
	if(mbl_finracc!=NULL) mbl_finracc=NULL;
}
