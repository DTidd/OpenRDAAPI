/* venadr.c - Vendor Payments Address Master Program*/
/*lint -library */
#ifndef WIN32
#define __NAM__ "venadr.lnx"
#endif
#ifdef WIN32
#define __NAM__ "venadr.exe"
#endif
#include <app.h>
#include <rdaglob.h>
#include <rdaflds.h>
...
extern void venadrm(short,void *);
static void doexit(MakeBrowseList *),okfunc(MakeBrowseList *,void *);
static void new_record(RDArsrc *,MakeBrowseList *);
char editable=TRUE;
void browse_venadr(RDArsrc *parent,RDATData *);
MakeBrowseList *mbl_venadr=NULL;
MaintainMaster *MASTER=NULL;
short invitm=(-1);

void browse_venadr(RDArsrc *parent,RDATData *previous)
{
	...
	mbl_venadr=ADVPbrowse(MASTER->passkey->fileno,MASTER->passkey->keyno,
...
void main(int argc,char **argv)
{
	...
	char *module="VENPMT",*mtnname="MTN VENADR";
...
static void doexit(MakeBrowseList *blist)
{
	...
	if(mbl_venadr!=NULL) mbl_venadr=NULL;
}
