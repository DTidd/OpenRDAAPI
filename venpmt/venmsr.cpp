/* venmsr.c - Vendor Payments Vendor Master Program*/
/*lint -library */
#ifndef WIN32
#define __NAM__ "venmsr.lnx"
#endif
#ifdef WIN32
#define __NAM__ "venmsr.exe"
#endif
#include <app.h>
#include <rdaglob.h>
#include <rdaflds.h>
...
void browse_venmsr(RDArsrc *parent,RDATData *);
MakeBrowseList *mbl_venmsr=NULL;
MaintainMaster *MASTER=NULL;
short invitm=(-1);

void browse_venmsr(RDArsrc *parent,RDATData *previous)
{
	...
	mbl_venmsr=ADVPbrowse(MASTER->passkey->fileno,MASTER->passkey->keyno,
...
void main(int argc,char **argv)
{
	...
	char *module="VENPMT",*mtnname="MTN VENMSR";
...
static void doexit(MakeBrowseList *blist)
{
	...
	if(mbl_venmsr!=NULL) mbl_venmsr=NULL;
}
