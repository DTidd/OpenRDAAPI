/* purrec.c - Purchase Order Receives Master Program*/
/*lint -library */
#ifndef WIN32
#define __NAM__ "purrec.lnx"
#endif
#ifdef WIN32
#define __NAM__ "purrec.exe"
#endif
#include <app.hpp>
...
extern void purrecm(short,void *);
static void doexit(MakeBrowseList *),okfunc(MakeBrowseList *,void *);
static void new_record(RDArsrc *,MakeBrowseList *);
char editable=TRUE;
void browse_purrec(RDArsrc *parent,RDATData *);
MakeBrowseList *mbl_purrec=NULL;
MaintainMaster *MASTER=NULL;
short purmst=(-1);

void browse_purrec(RDArsrc *parent,RDATData *previous)
{
	...
	mbl_purrec=ADVPbrowse(MASTER->passkey->fileno,MASTER->passkey->keyno,
...
int main(int argc,char **argv)
{
	...
	char *module="PURORD",*mtnname="MTN PURREC";
...
static void doexit(MakeBrowseList *blist)
{
	...
	if(mbl_purrec!=NULL) mbl_purrec=NULL;
}
