...
#ifndef WIN32
#define __NAM__ "purapvcms.lnx"
#endif
#ifdef WIN32
#define __NAM__ "purapvcms.exe"
#endif
#include <app.hpp>
...
/*CPP_OPART puravci */
/*CPP_OPART puravcim */
/*CPP_OPART purapv1cms */
/*CPP_OPART purapv2cms */
/*ADDLIB mix */
/*ADDLIB olh */
/*ADDLIB sec */
/*ADDLIB trans */
...
int PO_COUNT=0;
char *poid=NULL,*vendorid=NULL,*invid=NULL,*checkdate=NULL,manual_voucher=FALSE,prepaid=FALSE,pay_1099=FALSE,check_detail=FALSE;
...
int main(int argc,char **argv)
{
	...
	temp=RDA_GetEnv("SKIP_INVOICE_DATE");
	if(!isEMPTY(temp)) skip_invoice_date=TRUE;
		else skip_invoice_date=FALSE;	
