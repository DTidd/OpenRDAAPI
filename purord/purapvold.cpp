...
#ifndef WIN32
#define __NAM__ "purapvold.lnx"
#endif
#ifdef WIN32
#define __NAM__ "purapvold.exe"
#endif
#include <app.hpp>
...
#include <venpmt.hpp>
#include <purord.hpp>
/*CPP_OPART puravciold */
/*CPP_OPART puravcimold */
/*CPP_OPART purapv1old */
/*CPP_OPART purapv2old */
/*ADDLIB mix */
/*ADDLIB olh */
/*ADDLIB sec */
/*ADDLIB trans */
...
short yearnum=(-1),fyearnum=(-1),percis=(-1);
