...
#endif
#ifdef USE_MARIADB
#include "mysql/private/maria/ha_maria.h"
#include "mysql/private/maria/maria_def.h"
#else
#include "myisam.h"
#include "myisamdef.h"
#include "my_base.h"
...
//	init_key_cache(dflt_key_cache,key_cache_block_size,  size_t use_mem, uint division_limit,  uint age_threshold, uint partitions);

//MariaDB 5.5.33a
//extern int init_key_cache(KEY_CACHE *keycache, uint key_cache_block_size,  size_t use_mem, uint division_limit,  uint age_threshold, uint partitions);


// MySQL 5.0.37
//extern int init_key_cache(KEY_CACHE *keycache, uint key_cache_block_size,  ulong use_mem, uint division_limit,  uint age_threshold);
	return(0);
}
...
/* HERE RDA_NOGUI LOCKING UP in mi_rkey */
