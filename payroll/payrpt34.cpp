...
extern char *module;
void ADDDED1(void);
static void ADDDED1_BROWSE(void);
static void ADDDED1_DEFINE_LIST(void);
static void ADDDED1_MAINTAIN_SCREEN(void);
static void ADDDED1_RANGE_SCREEN(void);
static void ADDDED1_SEARCH_BROWSE(void);
...
----------------------------------------------------------------------*/
	...
	memset(stemp,0,101);
	rptname=Rmalloc(7+1);
	sprintf(rptname,"ADDDED1");
	t=Rmalloc(48+1);
	sprintf(t,"Create Deduction Master's for Range of Employees");
	desc=Rmalloc(117+1);
	sprintf(desc,"This output definition is used to add Deduction Masters to selected Employee's with a previously specified deduction.");
...
----------------------------------------------------------------------*/
	...
	if(tmp!=NULL)
	{
		if(WRTRDAreport(module,tmp))
		{
			...
			ADDDED1_BROWSE();
			ADDDED1_DEFINE_LIST();
			ADDDED1_MAINTAIN_SCREEN();
			ADDDED1_SEARCH_BROWSE();
			ADDDED1_RANGE_SCREEN();
		}
		FreeRDAreport(tmp);
	}
	if(rptname!=NULL) Rfree(rptname);
}
static void ADDDED1_BROWSE()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","ADDDED1 BROWSE");
	if(scrn!=NULL)
	{
...
static void ADDDED1_DEFINE_LIST()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","ADDDED1 DEFINE LIST");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
...
static void ADDDED1_MAINTAIN_SCREEN()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","ADDDED1 MAINTAIN SCREEN");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		...
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Personnel ID:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[PAYDEDM][PERSONNEL IDENTIFICATION]","Personnel Identification","","",0,15,0,"","FALSE","","");
		ADVaddwdgt(scrn,5,"","Name:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[NAME LAST LINEAGE FIRST MIDDLE]","Name","","",0,40,0,"","FALSE","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Deduction Identification:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[NEW DEDUCTION DESCRIPTION IDENTIFICATION]","New Deduction Description Identification","","",0,30,0,"","","","");
		ADVaddwdgt(scrn,5,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
...
static void ADDDED1_RANGE_SCREEN()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","ADDDED1 RANGE SCREEN");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		...
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"RANGE ON [PAYDEDM][DEDUCTION DESCRIPTION IDENTIFICATION]","Range on Deduction Description IDs","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","From:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"FROM [PAYDEDM][DEDUCTION DESCRIPTION IDENTIFICATION]","From Deduction Description ID","","",0,30,0,"","","","");
		ADVaddwdgt(scrn,5,"","To:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"TO [PAYDEDM][DEDUCTION DESCRIPTION IDENTIFICATION]","To Deduction Description Identification","","",0,30,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		...
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"RANGE ON [NAME LAST LINEAGE FIRST MIDDLE]","Range on Employee Names","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,3,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		...
		ADVaddwdgt(scrn,3,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"FROM [NAME LAST LINEAGE FIRST MIDDLE]","From Name","","",0,40,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"TO [NAME LAST LINEAGE FIRST MIDDLE]","To Name","","",0,40,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,4,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
...
static void ADDDED1_SEARCH_BROWSE()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","ADDDED1 SEARCH BROWSE");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
