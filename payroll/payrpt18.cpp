/* PAYROLL's - Make (PAYDIST-WJC) Report */
#include <cstdio>
#include <rptgen.hpp>
/*COMPMEM 40960 */
...
extern char *module;
void PAYDIST_WJC(void);
static void PAYDIST_WJC_RANGE_SCREEN(void);
...
----------------------------------------------------------------------*/
	...
	tmp=RDAreportNEWADV(rptname,t,desc,1,"",FALSE,TRUE,FALSE,TRUE,TRUE,"PAYROLL","PAYDIST1-WJC",TRUE,1,FALSE,"");
	if(t!=NULL) Rfree(t);
...
----------------------------------------------------------------------*/
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[ACCOUNT CODE] FOOTER","  @LLLLLLLLLLLLLLLLLLLLLLLLLLLL  @LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL  @,.RRRRRRRRRRRRRRRRR@@",TRUE,"[LAST ACCOUNT TYPE]<2",5,pval);
	free_pvals(pval,5);
	...
	if(tmp!=NULL)
	{
		if(WRTRDAreport(module,tmp))
		{
			...
			PAYDIST_WJC_RANGE_SCREEN();
		}
		FreeRDAreport(tmp);
	}
	if(rptname!=NULL) Rfree(rptname);
}
static void PAYDIST_WJC_RANGE_SCREEN()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","PAYDIST-WJC RANGE SCREEN");
	if(scrn!=NULL)
	{
		...
		ADVaddwdgt(scrn,0,"FROM [PERDMG][PERSONNEL IDENTIFICATION]","From Personnel Identification","","",0,11,0,"","","","");
		ADVaddwdgt(scrn,5,"","To:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"TO [PERDMG][PERSONNEL IDENTIFICATION]","To Personnel Identification","","",0,11,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
