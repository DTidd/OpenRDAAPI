...
#ifndef WIN32
#define __NAM__ "payw2sng1996.lnx"
#endif
#ifdef WIN32
#define __NAM__ "payw2sng1996.exe"
#endif
#include <app.hpp>
...
static void printw2alignfunc(RDArsrc *prtrsrc,PassableStruct *p)
{
	...
	fprintf(fp," %11d%-54s\r\n",0," ");
	fprintf(fp," %-65s\r\n"," ");
	fprintf(fp," %-32s  %14.02f  %13.02f%-2s\r\n",X32,0.00,0.00," "); 
	fprintf(fp," %-65s\r\n"," ");
	fprintf(fp," %-32s  %14.02f  %13.02f%-2s\r\n",X32,0.00,0.00," "); 
	fprintf(fp," %-32s%-33s\r\n",X32," "); 
	fprintf(fp," %-32s  %14.02f  %13.02f%-2s\r\n",X32,0.00,0.00," "); 
	...
	fprintf(fp," %-32s  %14.02f  %13.02f%-2s\r\n",X32,0.00,0.00," "); 
	fprintf(fp," %-32s%-33s\r\n",X32," ");
	fprintf(fp," %-32s   %-1s %11.02f    %-12s%-1s\r\n",X32,"X",0.00,"XXXXXXXXXXXX"," ");
	fprintf(fp," %-32s   %-1s %11.02f    %-12s%-1s\r\n",X32,"X",0.00,"XXXXXXXXXXXX"," ");
	fprintf(fp," %-32s   %-1s %11.02f    %-12s%-1s\r\n",X32,"X",0.00,"XXXXXXXXXXXX"," ");
	fprintf(fp," %-32s   %-1s %11.02f    %-12s%-1s\r\n"," ","X",0.00,"XXXXXXXXXXXX"," ");
	fprintf(fp," %-65s\r\n"," ");
	fprintf(fp,"                                    %c   %c   %c   %c   %c       %c %-5s\r\n",'X','X','X','X','X','X'," "); 
	fprintf(fp," %-65s\r\n"," ");
	fprintf(fp," %-3s %-13s  %9.02f %9.02f  ","XX","XXXXXXXXXXXXX",0.00,0.00); fprintf(fp,"%-6s  %8.02f %7.02f\r\n","XXXXXX",0.00,0.00); 
	fprintf(fp," %-65s\r\n"," ");
	fprintf(fp," %-3s %-13s  %9.02f %9.02f  ","XX","XXXXXXXXXXXXX",0.00,0.00); fprintf(fp,"%-6s  %8.02f %7.02f\r\n","XXXXXX",0.00,0.00); 
	fprintf(fp," %-65s\r\n"," ");
	fprintf(fp," %-65s\r\n"," ");
...
*/
						...
						fprintf(fp," %11d%-54s\r\n",cont_no," ");
						fprintf(fp," %-65s\r\n"," ");
						fprintf(fp," %-32s  %14.02f  %13.02f%-2s\r\n",empr_idno,box1/100,box2/100," ");
						fprintf(fp," %-65s\r\n"," ");
						fprintf(fp," %-32s  %14.02f  %13.02f%-2s\r\n",empr_name1,box3/100,box4/100," ");
						fprintf(fp," %-32s%-33s\r\n",empr_name2," ");
						fprintf(fp," %-32s  %14.02f  %13.02f%-2s\r\n",empr_addr1,box5/100,box6/100," ");
						fprintf(fp," %-32s%-33s\r\n",empr_addr2," ");
						fprintf(fp," %-32s  %14.02f  %13.02f%-2s\r\n",empr_addr3,box7/100,box8/100," ");
						fprintf(fp," %-65s\r\n"," ");
						...
						if((BOX13->num)<1)
						{
							if(box14A!=0.00)
							{
								fprintf(fp," %-32s                    %-12s%-1s\r\n",empl_addr2,box14A_label," ");
								fprintf(fp," %-32s                   %12.02f%-2s\r\n",empl_addr3,(box14A/100)," ");
							} else {
								fprintf(fp," %-32s%-33s\r\n",empl_addr2," ");
								fprintf(fp," %-32s%-33s\r\n",empl_addr3," ");
							}
							...
							if((BOX13->num)>1)
							{
								...
								if(box14A!=0.00)
								{
									fprintf(fp," %-32s   %-1s %11.02f   %12.02f%-2s\r\n",empl_addr3,b->label,b->amount/100,box14A/100," ");
								} else {
									fprintf(fp," %-32s   %-1s %11.02f%-17s\r\n",empl_addr3,b->label,b->amount/100," ");
								}
							} else { 
								if(box14A!=0.00)
								{
						...
						{
							fprintf(fp," %-3s %-13s   %9.02f%8.02f  ",st1_label,st1_ein,st1_gross/100,st1_amount/100);
						} else {
							fprintf(fp,"                                        ");
						}
						if((!isEMPTY(loc1_label)) && (loc1_gross!=0.0))
						{
							fprintf(fp,"%-7s %8.02f %7.02f%-2s\r\n",loc1_label,loc1_gross/100,loc1_amount/100," ");
						} else {
							fprintf(fp,"%-26s\r\n"," ");
						}
						fprintf(fp," %-65s\r\n"," ");
						...
						{
							fprintf(fp," %-3s %-13s   %9.02f%8.02f  ",st2_label,st2_ein,st2_gross/100,st2_amount/100);
						} else {
							fprintf(fp,"                                        ");
						}
						...
						if(mod_value==0) 
						{
							...
							fprintf(fp," %-32s%-33s\r\n",empr_addr2," ");
							fprintf(fp," %-32s  %14.02f  %13.02f%-2s\r\n",empr_addr3,subtotal_box7/100,subtotal_box8/100," ");
							fprintf(fp," %-65s\r\n"," ");
...
int main(int argc,char **argv)
{
	...
	if(InitializeSubsystems(argc,argv,module,"PRINT W2 SINGLE")) 
	{
		RDAAPPMAINLOOP();
		return;
	}
	...
	mainrsrc=RDArsrcNEW(module,"PRINT W2 SINGLE");
