...
----------------------------------------------------------------------*/
	...
	tmp=RDAreportNEWADV(rptname,t,desc,1,"",FALSE,TRUE,FALSE,TRUE,TRUE,"PAYROLL","PAYNETA1",FALSE,0,FALSE,"");
	if(t!=NULL) Rfree(t);
...
----------------------------------------------------------------------*/
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[PAYROLL][PAYDPMS][PAY IDENTIFICATION] HEADER","@VVVVVVVVV @VVVVVVVVVVVVV @VVVVVVVV@@",FALSE,NULL,5,pval);
	free_pvals(pval,5);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[PRSNNL][PERDMG][LOCATION IDENTIFICATION] HEADER"," LOCATION @LLLLLLLLLLLLLLLLLLL@@",FALSE,NULL,3,pval);
	free_pvals(pval,3);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[PAYROLL][PAYDPMS][PERSONNEL IDENTIFICATION] HEADER","  @VVVVVVVVVVVVVVVVVVV @VVVVVVVVVVVVVVVVVVVVVVVVV  @LLLLLLLLLLLLLLLLLLLL@@",FALSE,NULL,5,pval);
	free_pvals(pval,5);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"DETAIL LINES","  @LLLLLLLLLLLLLLLL @LLLLLLLLLLLLLLLLLLLLLLLLLLLL @,.RRRRRRRRRRRRRR @,.RRRRRRRRRRRR@@",FALSE,NULL,6,pval);
	free_pvals(pval,6);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[PAYROLL][PAYDPMS][PERSONNEL IDENTIFICATION] FOOTER","                                                  ----------------- ---------------@@",FALSE,NULL,2,pval);
	free_pvals(pval,2);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[PAYROLL][PAYDPMS][PERSONNEL IDENTIFICATION] FOOTER","  TOTAL PERSONNEL: @LLLLLLLLLLLLLLLLLLLLLLLLLLLLLL @,.RRRRRRRRRRRRRR @,.RRRRRRRRRRRR@@",FALSE,NULL,5,pval);
	free_pvals(pval,5);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[PAYROLL][PAYDPMS][PAY IDENTIFICATION] FOOTER","        TOTAL PAY: @LLLLLLLLLLLLLLLLLLLLLLLLLLLLLL @,.RRRRRRRRRRRRRR @,.RRRRRRRRRRRR@@",FALSE,NULL,5,pval);
	free_pvals(pval,5);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT FOOTER","                                        TOTAL ALL: @,.RRRRRRRRRRRRRR @,.RRRRRRRRRRRR@@",FALSE,NULL,4,pval);
	free_pvals(pval,4);
