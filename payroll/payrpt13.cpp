/* PAYROLL's - Make (PREDIRDEP1) Report */
#include <cstdio>
#include <rptgen.hpp>
/*COMPMEM 40960 */
...
----------------------------------------------------------------------*/
	...
	sprintf(rptname,"PREDIRDEP1");
	t=Rmalloc(38+1);
	sprintf(t,"Prenotification Direct Deposits Report");
	desc=Rmalloc(93+1);
	sprintf(desc,"This output definition is used to generate an Actual Pernotification Direct Deposit Diskette.");
...
------------------------------------------------------------------------*/
	...
	pvars=NULL;
	adddisplayADV(tmp,(double)0.000000,(double)0.000000,1,FALSE,0,"predrdp",0,1,0,pvars);
	free_pvars(pvars,0);
...
ROLL][PAYDEDM][ACTIVE]=TRUE) AND ([PAYROLL][PAYDEDM][ACH ACTIVE]=FALSE)) \nFI");
	...
	t=Rmalloc(82+1);
	sprintf(t,"([PRSNNL][PERDMG][DELETEFLAG]=FALSE) AND ([PRSNNL][PERDMG][CURRENT EMPLOYEE]=TRUE)");
	...
	x=addsearchfileADV(tmp,"PAYROLL","PAYDTYP",1,"PAYROLL","PAYDEDM","PAYDTYP KEY",FALSE,NULL,NULL,1);
	if(x!=(-1))
	{
		s=tmp->search+(x-1);
...
NT NUMBER]=[LAST BANK ACCOUNT NUMBER]))\nTHEN RETURN_VALUE=[LINE COUNT] \nELSE RETURN_VALUE=([LINE COUNT]+1) \nFI");
	...
	addvirtuallineADV(tmp,"INDIVIDUAL NAME",1,15,t,0,0);
...
----------------------------------------------------------------------*/
	...
	addaccumline(tmp,"LAST BANK ACCOUNT",3,"[PAYROLL][PAYDEDM][BANK ACCOUNT NUMBER]",0);
...
----------------------------------------------------------------------*/
	...
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT HEADER","101@LLLLLLLLL@LLLLLLLLL@LLLLL@LLL@@LL@L@@LLLLLLLLLLLLLLLLLLLLLL@LLLLLLLLLLLLLLLLLLLLLL@LLLLLLL@@",TRUE,"[FIRST USE CARRIAGE RETURN/LINE FEED]",13,pval);
	free_pvals(pval,13);
	...
	pvals->name=stralloc("[REFERENCE CODE]");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT HEADER","101@LLLLLLLLL@LLLLLLLLL@LLLLL@LLL@@LL@L@@LLLLLLLLLLLLLLLLLLLLLL@LLLLLLLLLLLLLLLLLLLLLL@LLLLLLL",TRUE,"NOT([FIRST USE CARRIAGE RETURN/LINE FEED])",11,pval);
	free_pvals(pval,11);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT HEADER","5220@LLLLLLLLLLLLLLL@LLLLLLLLLLLLLLLLLLL@LLLLLLLLL@LL@LLLLLLLLL@LLLLL@LLLLL   1@LLLLLLL@0RRRRR@@",TRUE,"[FIRST USE CARRIAGE RETURN/LINE FEED]",11,pval);
	free_pvals(pval,11);
	...
	pvals->name=stralloc("[BATCH NUMBER]");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT HEADER","5220@LLLLLLLLLLLLLLL@LLLLLLLLLLLLLLLLLLL@LLLLLLLLL@LL@LLLLLLLLL@LLLLL@LLLLL   1@LLLLLLL@0RRRRR",TRUE,"NOT([FIRST USE CARRIAGE RETURN/LINE FEED])",9,pval);
	free_pvals(pval,9);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT FOOTER","8220@0RRRR@000000000@0RRRRRRRRRR@0RRRRRRRRRR@LLLLLLLLL                         @LLLLLLL@0RRRRR@@",TRUE,"[LAST USE CARRIAGE RETURN/LINE FEED]",9,pval);
	free_pvals(pval,9);
	...
	pvals->name=stralloc("[BATCH NUMBER]");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT FOOTER","8220@0RRRR@000000000@0RRRRRRRRRR@0RRRRRRRRRR@LLLLLLLLL                         @LLLLLLL@0RRRRR",TRUE,"NOT([LAST USE CARRIAGE RETURN/LINE FEED])",7,pval);
	free_pvals(pval,7);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT FOOTER","9@0RRRR@0RRRR@0RRRRRR@000000000@0RRRRRRRRRR@0RRRRRRRRRR                                       @@",TRUE,"[LAST USE CARRIAGE RETURN/LINE FEED]",8,pval);
	free_pvals(pval,8);
	...
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT FOOTER","9@0RRRR@0RRRR@0RRRRRR@000000000@0RRRRRRRRRR@0RRRRRRRRRR                                      @",TRUE,"NOT([LAST USE CARRIAGE RETURN/LINE FEED])",7,pval);
	free_pvals(pval,7);
