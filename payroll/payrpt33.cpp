...
extern char *module;
void ADDDED(void);
static void ADDDED_BROWSE(void);
static void ADDDED_DEFINE_LIST(void);
static void ADDDED_RANGE_SCREEN(void);
static void ADDDED_MAINTAIN_SCREEN(void);
static void ADDDED_SEARCH_BROWSE(void);
...
----------------------------------------------------------------------*/
	...
	memset(stemp,0,101);
	rptname=Rmalloc(6+1);
	sprintf(rptname,"ADDDED");
	t=Rmalloc(48+1);
	sprintf(t,"Create Deduction Master's for Range of Employees");
	desc=Rmalloc(79+1);
	sprintf(desc,"This output definition is used to add Deduction Masters to selected Employee's.");
	tmp=RDAreportNEWADV(rptname,t,desc,1,"",TRUE,FALSE,FALSE,FALSE,FALSE,"","",TRUE,1,TRUE,"");
	if(t!=NULL) Rfree(t);
...
------------------------------------------------------------------------*/
	...
	x=addsearchfileADV(tmp,"PRSNNL","PERDMG",1,"PAYROLL","PAYJMST","PERDMG KEY",TRUE,t,NULL,1);
	if(x!=(-1))
	{
		s=tmp->search+(x-1);
	...
	x=addsearchfileADV(tmp,"POSTRK","POSMSTR",1,"PAYROLL","PAYJMST","POSMSTR",TRUE,t,NULL,1);
	if(x!=(-1))
	{
		s=tmp->search+(x-1);
...
------------------------------------------------------------------------*/
	...
	if(t!=NULL) Rfree(t);
	addvirtuallineADV(tmp,"NEW DEDUCTION DESCRIPTION IDENTIFICATION",1,20,t,0,2);

	if(t!=NULL) Rfree(t);
	t=Rmalloc(4+1);
	sprintf(t,"TRUE");
	addvirtuallineADV(tmp,"NEW ACTIVE DEDUCTION",10,1,t,0,0);

	if(t!=NULL) Rfree(t);
	t=Rmalloc(1+1);
	sprintf(t,"0");
	addvirtuallineADV(tmp,"ADJUSTMENT AMOUNT",2,20,t,0,0);

	if(t!=NULL) Rfree(t);
	t=Rmalloc(1+1);
	sprintf(t,"0");
	addvirtuallineADV(tmp,"LIMIT AMOUNT",2,20,t,0,0);
	...
	t=Rmalloc(1+1);
	sprintf(t,"0");
	addvirtuallineADV(tmp,"PERCENTAGE",6,10,t,0,0);
...
----------------------------------------------------------------------*/
	...
	addaccumline(tmp,"LAST NEW DEDUCTION DESCRIPTION IDENTIFICATION",0,"[NEW DEDUCTION DESCRIPTION IDENTIFICATION]",0);
	addaccumline(tmp,"LAST PERSONNEL IDENTIFICATION",2,"[PRSNNL][PERDMG][PERSONNEL IDENTIFICATION]",0);
	addaccumline(tmp,"LAST NAME",3,"[PRSNNL][PERDMG][NAME]",0);
	addaccumline(tmp,"LAST NEW ACTIVE",3,"[NEW ACTIVE DEDUCTION]",0);
...
----------------------------------------------------------------------*/
	...
	if(tmp!=NULL)
	{
		if(WRTRDAreport(module,tmp))
		{
			...
			ADDDED_DEFINE_LIST();
			ADDDED_RANGE_SCREEN();
			ADDDED_MAINTAIN_SCREEN();
			ADDDED_SEARCH_BROWSE();
		}
		FreeRDAreport(tmp);
	}
	if(rptname!=NULL) Rfree(rptname);
}
static void ADDDED_BROWSE()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","ADDDED BROWSE");
	if(scrn!=NULL)
	{
...
static void ADDDED_DEFINE_LIST()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","ADDDED DEFINE LIST");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		...
		ADVaddwdgt(scrn,3,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[PRSNNL][PERDMG][PERSONNEL IDENTIFICATION] POSITION","Personnel ID Position","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,0,"[PRSNNL][PERDMG][PERSONNEL IDENTIFICATION] LENGTH","Personnel Identification Length","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,4,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Deduction Identification:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,3,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[NEW DEDUCTION DESCRIPTION IDENTIFICATION] POSITION","Deduction Identification Position","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,0,"[NEW DEDUCTION DESCRIPTION IDENTIFICATION] LENGTH","Deduction Description Identification Length","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,4,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Active:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,3,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[NEW ACTIVE DEDUCTION] POSITION","New Active Deduction Position","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,0,"[NEW ACTIVE DEDUCTION] LENGTH","New Active Deduction Length","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,4,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Adjustment Amount:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,3,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[ADJUSTMENT AMOUNT] POSITION","Adjustment Amount Position","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,0,"[ADJUSTMENT AMOUNT] LENGTH","Adjustment Amount Length","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,4,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Limit Amount:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,3,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[LIMIT AMOUNT] POSITION","Limit Amount Position","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,0,"[LIMIT AMOUNT] LENGTH","Limit Amount Length","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,4,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Exemption:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,3,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[EXEMPTION] POSITION","Exemption Position","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,0,"[EXEMPTION] LENGTH","Exemption Length","","",0,3,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,4,"","","","",0,0,0,"","","","");
...
static void ADDDED_MAINTAIN_SCREEN()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","ADDDED MAINTAIN SCREEN");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		...
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Personnel ID:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[PRSNNL][PERDMG][PERSONNEL IDENTIFICATION]","Personnel Identification","","",0,15,0,"","FALSE","","");
		ADVaddwdgt(scrn,5,"","Name:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[PRSNNL][PERDMG][NAME]","Name","","",0,40,0,"","FALSE","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Deduction Identification:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[NEW DEDUCTION DESCRIPTION IDENTIFICATION]","New Deduction Description Identification","","",0,20,0,"","","","");
		ADVaddwdgt(scrn,5,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"[NEW ACTIVE DEDUCTION]","Active","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Adjustment Amount:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[ADJUSTMENT AMOUNT]","Adjustment Amount","","",0,20,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Exemptions:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[EXEMPTION]","Exemptions","","",0,2,0,"","","","");
		ADVaddwdgt(scrn,5,"","Limit Amount:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[LIMIT AMOUNT]","Limit Amount","","",0,20,0,"","","","");
		ADVaddwdgt(scrn,5,"","Percentage:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[PERCENTAGE]","Percentage","","",0,10,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,3,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
...
static void ADDDED_RANGE_SCREEN()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","ADDDED RANGE SCREEN");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","New Deduction Description Identification:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"NEW DEDUCTION DESCRIPTION IDENTIFICATION","New Deduction Description Identification","","",0,20,0,"","","","");
		ADVaddwdgt(scrn,5,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		...
		ADVaddwdgt(scrn,5,"","From:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"FROM [PAYJMST][GROSS IDENTIFICATION]","From Gross ID","","",0,15,0,"","","","");
		ADVaddwdgt(scrn,5,"","To:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"TO [PAYJMST][GROSS IDENTIFICATION]","To Gross Identification","","",0,15,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"RANGE ON [PAYJMST][NUMBER OF PAYS]","Range on Number of Pays","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","From:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"FROM [PAYJMST][NUMBER OF PAYS]","From Number of Pays","","",0,2,0,"","","","");
		ADVaddwdgt(scrn,5,"","To:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"TO [PAYJMST][NUMBER OF PAYS]","To Number of Pays","","",0,2,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"RANGE ON [PAYJMST][CONTRACT MONTHS]","Range on Contract Months","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","From:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"FROM [PAYJMST][CONTRACT MONTHS]","From Contract Months","","",0,2,0,"","","","");
		ADVaddwdgt(scrn,5,"","To:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"TO [PAYJMST][CONTRACT MONTHS]","To Contract Months","","",0,2,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
...
static void ADDDED_SEARCH_BROWSE()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","ADDDED SEARCH BROWSE");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
