...
----------------------------------------------------------------------*/
	...
	memset(stemp,0,101);
	rptname=Rmalloc(7+1);
	sprintf(rptname,"PAYSELA");
	t=Rmalloc(26+1);
	sprintf(t,"Select Payroll Audit Trail");
	desc=Rmalloc(76+1);
	sprintf(desc,"This output definition is used to provide an audit trail for Select Payroll.");
	tmp=RDAreportNEWADV(rptname,t,desc,1,"",FALSE,TRUE,FALSE,TRUE,TRUE,"PAYROLL","PAYSELA1",FALSE,0,FALSE,"");
	if(t!=NULL) Rfree(t);
...
----------------------------------------------------------------------*/
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[PAYROLL][PAYJPRM][PAY IDENTIFICATION] HEADER","@VVVVVVVVVV @VVVVVVVVVVVVVV @VVVVV@@",FALSE,NULL,5,pval);
	free_pvals(pval,5);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[PAYROLL][PAYJPRM][PERSONNEL IDENTIFICATION] HEADER","  @VVVVVVVVVVVVVVV @VVVVVVVVVVVVVVVVVVVVVVVV@@",FALSE,NULL,4,pval);
	free_pvals(pval,4);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"DETAIL LINES","    @RR @LLLLLLLLLLLLLLL @LLLLLLLLLLLLLLL @LLLLLLLLLLLLLLL @RRRRR.RR @,.RRRRRRRRRRRR@@",FALSE,NULL,8,pval);
	free_pvals(pval,8);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[PAYROLL][PAYJPRM][JOB NUMBER] FOOTER","                                          TOTAL JOB#: @RR  @RRRRR.RR @,.RRRRRRRRRRRR@@",TRUE,"([FREQUENCY]>1)",5,pval);
	free_pvals(pval,5);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[PAYROLL][PAYJPRM][PERSONNEL IDENTIFICATION] FOOTER","    TOTAL PERSONNEL IDENTIFICATION: @LLLLLLLLLLLLLLLLLLLL  @RRRRR.RR @,.RRRRRRRRRRRR@@",TRUE,"([FREQUENCY]>1)",5,pval);
	free_pvals(pval,5);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"[PAYROLL][PAYJPRM][PAY IDENTIFICATION] FOOTER","          TOTAL PAY IDENTIFICATION: @LLLLLLLLLLLLLLLLLLLL  @RRRRR.RR @,.RRRRRRRRRRRR@@",TRUE,"([FREQUENCY]>1)",5,pval);
	free_pvals(pval,5);
