/* PAYROLL's - Make (DIRDEPDSK) Report */
#include <cstdio>
#include <rptgen.hpp>
/*COMPMEM 40960 */
...
extern char *module;
void DIRDEPDSK(void);
static void DIRDEPDSK_RANGE_SCREEN(void);
...
----------------------------------------------------------------------*/
	...
	tmp=RDAreportNEWADV(rptname,t,desc,1,"",FALSE,TRUE,FALSE,TRUE,TRUE,"PAYROLL","DIRDEPDSK1",TRUE,0,FALSE,"");
	if(t!=NULL) Rfree(t);
...
------------------------------------------------------------------------*/
	...
	pvars=NULL;
	adddisplayADV(tmp,(double)0.000000,(double)0.000000,0,FALSE,0,"",0,1,0,pvars);
	free_pvars(pvars,0);
...
------------------------------------------------------------------------*/
	...
	t=Rmalloc(103+1);
	sprintf(t,"([PAYROLL][PAYDEDM][DELETEFLAG]=FALSE) AND (NOT([PAYROLL][PAYDEDM][ACH ACTIVE]=[PRENOTIFICATION ONLY]))");
...
----------------------------------------------------------------------*/
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT HEADER","5220@LLLLLLLLLLLLLLL@LLLLLLLLLLLLLLLLLLL@LLLLLLLLL@LL@LLLLLLLLL@LLLLL@LLLLL   1@LLLLLLL@R0RRRR@@",FALSE,NULL,11,pval);
	free_pvals(pval,11);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT FOOTER","8220@0RRRR@0RRRRRRRR@0RRRRRRRRRR@0RRRRRRRRRR@@LLLLLLLL                         @LLLLLLL@0RRRRR@@",FALSE,NULL,10,pval);
	free_pvals(pval,10);
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT FOOTER","9@0RRRR@0RRRR@0RRRRRR@0RRRRRRRR@0RRRRRRRRRR@0RRRRRRRRRR                                       @@",FALSE,NULL,8,pval);
	free_pvals(pval,8);
	...
	pvals->symbol_type=0;
	pvals->type=0;
	pvals->name=stralloc("[TOTAL DEBIT ENTRY AMOUNT DOLLARS]");
	pvals->fieldname=NULL;
	++pvals;
	pvals->symbol_type=0;
	pvals->type=0;
	pvals->name=stralloc("[TOTAL CREDIT ENTRY AMOUNT DOLLARS]");
	pvals->fieldname=NULL;
	++pvals;
	pvals->symbol_type=1;
	pvals->type=0;
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT FOOTER","Total Debit Amount: @,.RRRRRRRRRRRRRRRRRRRR  Total Credit Amount: @,.RRRRRRRRRRRRRRRRRR@@",FALSE,NULL,4,pval);
	free_pvals(pval,4);
	...
	pvals->symbol_type=0;
	pvals->type=0;
	pvals->name=stralloc("[TOTAL HASH NUMBER]");
	pvals->fieldname=NULL;
	++pvals;
	pvals->symbol_type=0;
	pvals->type=0;
	pvals->name=stralloc("[TOTAL ENTRY HASH AMOUNT]");
	pvals->fieldname=NULL;
	++pvals;
	pvals->symbol_type=1;
	pvals->type=0;
	...
	pvals->name=stralloc("LINEFEED");
	pvals->fieldname=NULL;
	addimageline(tmp,"REPORT FOOTER","Total Hash Number:  @RRRRRRRRRRRRRRRRRRRRR   Total Hash:   @RRRRRRRRRRRRRRRRRRRRRRRRRR@@",FALSE,NULL,4,pval);
	free_pvals(pval,4);
	...
	if(tmp!=NULL)
	{
		if(WRTRDAreport(module,tmp))
		{
			...
			DIRDEPDSK_RANGE_SCREEN();
		}
		FreeRDAreport(tmp);
	}
	if(rptname!=NULL) Rfree(rptname);
}
/* PAYROLL's - Make (DIRDEPDSK RANGE SCREEN) Screen */

static void DIRDEPDSK_RANGE_SCREEN()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
============================================================================*/
	...
	scrn=RDAscrnNEW("PAYROLL","DIRDEPDSK RANGE SCREEN");
	if(scrn!=NULL)
	{
		...
		ADVaddwdgt(scrn,0,"SELECTED BANK IDENTIFICATION","Selected Bank Identification","","",0,25,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		...
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"PRENOTIFICATION ONLY","Prenotification Only","","",0,0,0,"","","","");
		...
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"RANGE ON [PAYJDPM][PERSONNEL IDENTIFICATION]","Range on Personnel Identification","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","From:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"FROM [PAYJDPM][PERSONNEL IDENTIFICATION]","From Personnel Identification","","",0,25,0,"","","","");
		ADVaddwdgt(scrn,5,"","To:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"TO [PAYJDPM][PERSONNEL IDENTIFICATION]","To Personnel Identification","","",0,25,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
