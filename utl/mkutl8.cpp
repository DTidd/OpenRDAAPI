...
static void SCN_UTILITIES_DOCK_WINDOW()
{
	...
	if(scrn!=NULL)
	{
		...
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,24,"","Define Infrastructure","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Files","Files","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define EZ-Virtual Fields","EZ-Virtual Fields","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Generic Setup Variables","Generic Setup Variables","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Accounts","Accounts / Custom Inputs","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,25,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,24,"","Define Processes","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Power Add","Power Add","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Maintain Master","Maintain Master","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Reports","Reports","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Import/Export","Import/Export","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Change Files","Change Files","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define EZ Reports","EZ Reports","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,25,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,24,"","Define Resources","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Screens","Screens","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Scrolled Lists","Scrolled Lists","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Screen Defaults","Screen Defaults","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Matrix","Matrix","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Tables","Tables","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Load Buttons","Load Buttons","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Help","Help","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,25,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,24,"","Output Devices","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Define Output Devices","Define","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"Set Up Output Devices","Set Up","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,25,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
