/* DATABASE's - Make (IBSBACKUPSC) Power Add */
#include <cstdio>
#include <mkadd.hpp>
#include <mkmsc.hpp>
...
/* QUIT WARNING DESCRIPTION */
	...
	sprintf(temp9,"%s",
		"");
	add=RDAPowerAddNEW(module,"IBSBACKUPSC",temp1,"ADD IBSBACKUPS","ADD IBSBACKUPS DEFINE LIST","",1,temp2,temp3,temp4,temp5,temp6,temp7,temp8,temp9,0,NULL,0,NULL,0,NULL,0,NULL);
...
/* POST CYBERSUPPORT HTTP POST BUTTON  */
		...
		temp2=Rmalloc(141+1);
		sprintf(temp2,"%s%s",
			"\"http://\"+(GENERIC_SETUP_VARIABLE(\"[UTILITIES][RDA SUPPORT IP ADDRESS]\"))+\":80/cgi-bin/IBSBACKU",
			"P.cgi\"");
		...
		if(x!=(-1))
		{
			...
			x=addPowerAddButtonField(button,"[DATE]","DATE");
			x=addPowerAddButtonField(button,"[FILENAME]","FILENAME");
			x=addPowerAddButtonField(button,"[TIME]","TIME");
			x=addPowerAddButtonField(button,"[TYPE]","TYPE");
			x=addPowerAddButtonField(button,"[LOCAL SIZE]","LOCAL_SIZE");
		}
/* POST CYBERSUPPORT HTTP POST BUTTON  */
		temp1=Rmalloc(55+1);
		sprintf(temp1,"%s",
...
/* ADD_WEB_ID EDIT WIDGET */
		...
		sprintf(temp3,"%s",
			"");
		x=addPowerAddEditWdgts(add,"ADD_WEB_ID",1,15,2,temp1,0,"","","",0,NULL,temp2,"","ADD_WEB_ID",temp3,0,NULL,0,NULL);
		if(temp1!=NULL) Rfree(temp1);
		if(temp2!=NULL) Rfree(temp2);
		if(temp3!=NULL) Rfree(temp3);
...
/* DATE EDIT WIDGET */
		...
		sprintf(temp3,"%s",
			"");
		x=addPowerAddEditWdgts(add,"DATE",1,10,2,temp1,0,"","","",0,NULL,temp2,"","DATE",temp3,0,NULL,0,NULL);
		if(temp1!=NULL) Rfree(temp1);
		if(temp2!=NULL) Rfree(temp2);
		if(temp3!=NULL) Rfree(temp3);
...
/* TIME EDIT WIDGET */
		...
		sprintf(temp3,"%s",
			"");
		x=addPowerAddEditWdgts(add,"TIME",17,8,2,temp1,0,"","","",0,NULL,temp2,"","TIME",temp3,0,NULL,0,NULL);
		if(temp1!=NULL) Rfree(temp1);
		if(temp2!=NULL) Rfree(temp2);
		if(temp3!=NULL) Rfree(temp3);
...
/* LOCAL SIZE EDIT WIDGET */
		...
		sprintf(temp3,"%s",
			"");
		x=addPowerAddEditWdgts(add,"LOCAL SIZE",9,10,0,temp1,0,"","","",0,NULL,temp2,"","LOCAL SIZE",temp3,0,NULL,0,NULL);
		if(temp1!=NULL) Rfree(temp1);
		if(temp2!=NULL) Rfree(temp2);
		if(temp3!=NULL) Rfree(temp3);
...
/* TYPE EDIT WIDGET */
		...
		sprintf(temp3,"%s",
			"");
		x=addPowerAddEditWdgts(add,"TYPE",1,15,0,temp1,0,"","","",0,NULL,temp2,"","TYPE",temp3,0,NULL,0,NULL);
		if(temp1!=NULL) Rfree(temp1);
		if(temp2!=NULL) Rfree(temp2);
		if(temp3!=NULL) Rfree(temp3);
		...
		if(writePowerAdd(defdir,add))
		{
			...
			sprintf(temp1,"POWER ADD WRITE ERROR: Module [DATABASE] Power Add [IBSBACKUPSC], Can Not Save Power Add!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
...
static void MNU_DATABASE_IBSBACKUPSC()
{
	RDAmenu *menu=NULL;
	char *defdir=NULL;

	menu=RDAmenuNEW("DATABASE IBSBACKUPSC","doadd.EXT DATABASE \"IBSBACKUPSC\"");
	if(menu!=NULL)
	{
...
static void SCN_ADD_IBSBACKUPS_DEFINE_LIST()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("DATABASE","ADD IBSBACKUPS DEFINE LIST");
	if(scrn!=NULL)
	{
		...
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Local Size:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		ADVaddwdgt(scrn,3,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"LOCAL SIZE POSITION","Local Size Position","","",0,3,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"LOCAL SIZE LENGTH","Local Size Length","","",0,3,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,4,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [DATABASE] Screen [ADD IBSBACKUPS DEFINE LIST], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void SCN_ADD_IBSBACKUPS()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("DATABASE","ADD IBSBACKUPS");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,9,"HTTP USE PROXY","Http Use Proxy","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Http Proxy:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"HTTP PROXY","Http Proxy:","","",0,60,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Http Proxy Port:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"HTTP PROXY PORT","Http Proxy Port:","","",0,4,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Http Proxy To Use:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"HTTP PROXY TO USE","Http Proxy To Use:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Add_web_id:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"ADD_WEB_ID","Add_web_id:","","",0,15,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Date:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"DATE","Date:","","",0,10,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Time:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"TIME","Time:","","",0,8,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Filename:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"FILENAME","Filename:","","",0,120,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Local Size:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"LOCAL SIZE","Local Size:","","",0,10,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Type:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"TYPE","Type:","","",0,15,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,3,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [DATABASE] Screen [ADD IBSBACKUPS], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
/* QUIT WARNING DESCRIPTION */
	...
	sprintf(temp9,"%s",
		"");
	add=RDAPowerAddNEW(module,"IBSBACKUPLIST",temp1,"IBSBACKUPLIST","IBSBACKUPLIST DEFINE LIST","",3,temp2,temp3,temp4,temp5,temp6,temp7,temp8,temp9,0,NULL,0,NULL,0,NULL,0,NULL);
	if(temp1!=NULL) Rfree(temp1);
	if(temp2!=NULL) Rfree(temp2);
	if(temp3!=NULL) Rfree(temp3);
	if(temp4!=NULL) Rfree(temp4);
...
/* IBSBACKUPLIST HTTP POST-GET BUTTON  */
		temp1=Rmalloc(54+1);
		sprintf(temp1,"%s",
			"([HTTP USE PROXY]=FALSE) OR ([HTTP PROXY TO USE]=\"\")");
		...
		temp2=Rmalloc(131+1);
		sprintf(temp2,"%s%s",
			"\"http://\"+(GENERIC_SETUP_VARIABLE(\"[UTILITIES][RDA SUPPORT IP ADDRESS]\"))+\":80/cgi-bin/ibsbackup",
			"list.cgi\"");
		addAPPlib(args,temp2);
		if(temp2!=NULL) Rfree(temp2);
		x=addPowerAddButton(add,"HTTP POST-GET","","IBSBACKUPLIST","SECURITY","USERS","USERS KEY",temp1,1,1,args,0,NULL);
		if(args!=NULL) freeapplib(args);
		if(temp1!=NULL) Rfree(temp1);
		if(x!=(-1))
		{
...
/* ADD_WEB_ID EDIT WIDGET */
		...
		{
			if(temp1!=NULL) Rfree(temp1);
			temp1=Rmalloc(13+8+89+1);
			sprintf(temp1,"POWER ADD WRITE ERROR: Module [DATABASE] Power Add [IBSBACKUPLIST], Can Not Save Power Add!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void MNU_DATABASE_IBSBACKUPLIST()
{
	RDAmenu *menu=NULL;
	char *defdir=NULL;

	menu=RDAmenuNEW("DATABASE IBSBACKUPLIST","wwwdoadd.EXT DATABASE \"IBSBACKUPLIST\"");
	if(menu!=NULL)
	{
		defdir=Rmalloc(RDAstrlen(CURRENTDIRECTORY)+RDAstrlen(module)+10);
#ifndef WIN32
...
static void SCN_IBSBACKUPLIST()
{
	...
	scrn=RDAscrnNEW("DATABASE","IBSBACKUPLIST");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,9,"HTTP USE PROXY","Http Use Proxy","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		if(writescrnbin(defdir,scrn))
		{
			if(temp1!=NULL) Rfree(temp1);
			temp1=Rmalloc(13+8+89+1);
			sprintf(temp1,"SCREEN WRITE ERROR: Module [DATABASE] Screen [IBSBACKUPLIST], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void SCN_IBSBACKUPLIST_DEFINE_LIST()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("DATABASE","IBSBACKUPLIST DEFINE LIST");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Enter a position and length for each of the following:","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [DATABASE] Screen [IBSBACKUPLIST DEFINE LIST], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
{
	ADD_IBSBACKUPSC();
	MNU_DATABASE_IBSBACKUPSC();
	SCN_ADD_IBSBACKUPS_DEFINE_LIST();
	SCN_ADD_IBSBACKUPS();
	ADD_IBSBACKUPLIST();
	MNU_DATABASE_IBSBACKUPLIST();
	SCN_IBSBACKUPLIST();
	SCN_IBSBACKUPLIST_DEFINE_LIST();
}
