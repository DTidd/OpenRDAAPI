/* UTILITIES's - Make (FIND DATE POWERADD) Screen */
#include <mkmsc.hpp>

extern char *module;
extern APPlib *errorlist;

void FIND_DATE_POWERADD()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	...
	scrn=RDAscrnNEW("UTILITIES","FIND DATE POWERADD");
	if(scrn!=NULL)
	{
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [UTILITIES] Screen [FIND DATE POWERADD], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
...
void FIND_DATE_MAINTAIN_MASTER()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("UTILITIES","FIND DATE MAINTAIN MASTER");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,9,"RANGE ON MODULE","Range on Modules","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [UTILITIES] Screen [FIND DATE MAINTAIN MASTER], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
