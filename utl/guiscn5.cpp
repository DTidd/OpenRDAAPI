/* GUI's - Make (DEFINE SCREEN DEFAULTS) Screen */
#include <cstdio>
#include <mix.hpp>
extern char *module;

static void DEFINE_SCREEN_DEFAULTS()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
static void MAINTAIN_SCREEN_DEFAULTS()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
...
static void MAINTAIN_RESOURCE_DEFAULTS()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	...
	if(scrn!=NULL)
	{
		...
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,8,"RESOURCE VALUE","Resource Value","","",5,80,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,11,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
...
static void DEFINE_SCREEN_DEFAULTS_MENU()
{
	RDAmenu *menu=NULL;
	char *defdir=NULL;
