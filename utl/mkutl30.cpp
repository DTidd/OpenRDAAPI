...
static void IMPEXP_MENUITEM_EXPORT()
{
	...
	if(IMPEXP!=NULL)
	{
		...
		addIMPEXPfieldADV(IMPEXP,"UIMETRIC COUNT",8,16,8,NULL,1,NULL);
		...
		addIMPEXPfieldADV(IMPEXP,"ENVIRONMENT VALUE 5",14,32000,9999,NULL,1,NULL);
		addIMPEXPfieldADV(IMPEXP,"VISIBLE EXPRESSION",14,33000,9999,NULL,1,NULL);
