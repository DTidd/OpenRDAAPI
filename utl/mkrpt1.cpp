/* RPTGEN's - Make (REPORT GENERATOR MENU) Screen */
#include <cstdio>
#include <mix.hpp>

extern char *module;

static void REPORT_GENERATOR_MENU()
{
	RDAmenu *menu=NULL;
	char *defdir=NULL;

	menu=RDAmenuNEW("REPORT GENERATOR MENU","domenu.EXT RPTGEN \"REPORT GENERATOR MENU\"");
	if(menu!=NULL)
	{
...
static void MNU_LASER_FORM_TEST()
{
	RDAmenu *menu=NULL;
	char *defdir=NULL;

	menu=RDAmenuNEW("LASER FORM TEST","laser.EXT");
	if(menu!=NULL)
	{
		defdir=Rmalloc(RDAstrlen(CURRENTDIRECTORY)+RDAstrlen(module)+10);
#ifndef WIN32
...
static void MNU_TEST_ACTIVE_PRINTERS()
{
	RDAmenu *menu=NULL;
	char *defdir=NULL;

	menu=RDAmenuNEW("TEST ACTIVE PRINTERS","mkrpt.lnx \"TEST ACTIVE PRINTERS\"");
	if(menu!=NULL)
	{
		defdir=Rmalloc(RDAstrlen(CURRENTDIRECTORY)+RDAstrlen(module)+10);
#ifndef WIN32
...
void REPORT_GENERATOR()
{
	...
	scrn=RDAscrnNEW("RPTGEN","REPORT GENERATOR MENU");
	if(scrn!=NULL)
	{
		...
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,6,"DO REPORTS","Process Reports","","",0,0,0,"","","","");
		...
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,6,"DEFINE OUTPUT DEVICES","Define Output Devices","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"RPTGEN SETUP DEVICE","Setup Output Device","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"LASER FORM TEST","Laser Printer Test","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,6,"TEST ACTIVE PRINTERS","Test Active Printers","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
