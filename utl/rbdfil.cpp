/* rbdfil.c - Rebuild Data File */
#ifndef WIN32
#define __NAM__ "rbdfil.lnx"
#endif
#ifdef WIN32
#define __NAM__ "rbdfil.exe"
#endif
#include <app.hpp>
...
#endif
{
	...
	if(InitializeSubsystems(argc,argv,module,"REBUILD DATFILE")) 
	{
		return;
	}
	mainrsrc=RDArsrcNEW(module,"REBUILD DATA FILES");
	modlst=APPlibNEW();
