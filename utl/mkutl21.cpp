/* GUI's - Make (FIND CUSTOM INPUT FIELDS IN SCREENS) */
#include <cstdio>
#include <mkmsc.hpp>

extern APPlib *errorlist;
static char *module="GUI";
void FIND_CUSTOMFIELD_SCREEN(void);
static void FIND_CUSTOM_INPUT_FIELDS_IN_SCREENS(void);

void FIND_CUSTOMFIELD_SCREEN()
{
	FIND_CUSTOM_INPUT_FIELDS_IN_SCREENS();
}
static void FIND_CUSTOM_INPUT_FIELDS_IN_SCREENS()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	...
	scrn=RDAscrnNEW("GUI","FIND CUSTOM INPUT FIELDS IN SCREENS");
	if(scrn!=NULL)
	{
