/* OLHELP's - Make (MTN USCNNOT) Maintain Master */
#include <cstdio>
#include <mkmtn.hpp>
#include <mkdef.hpp>
#include <mkmsc.hpp>
...
static void MTN_USCNNOT()
{
	...
	MTNMSTR=RDAMaintainMasterNEW(module,"MTN USCNNOT","This Maintain Master definition is used to define the User Screen Notes Master.",1,"USCNNOT","USER SCREEN NOTES BROWSE","USER SCREEN NOTES DEFINE LIST",
		"USER SCREEN NOTES SEARCH BROWSE","USER SCREEN NOTES MAINTAIN SCREEN",0,1,0,0,"","","","","",FALSE,FALSE,FALSE,"");
	if(MTNMSTR!=NULL)
	{
		r=addMaintainMasterSupporting(MTNMSTR,"SECURITY","USERS",0,0,NULL,"USERS KEY","",FALSE,"","","","","OLHELP","USCNNOT");
		S=MTNMSTR->s+(r-1);
		addSupportingRDAconfld(S,"USER IDENTIFICATION","[USCNNOT][USER IDENTIFICATION]",FALSE);
...
void USCNNOT_USER_IDENTIFICATIONS()
{
	RDAScrolledList *scrn=NULL;
	char *defdir=NULL;

	scrn=RDAScrolledListNew("OLHELP","USCNNOT USER IDENTIFICATIONS");
	if(scrn!=NULL)
	{
		scrn->vtype=0;
		scrn->type=0;
		ScrolledListDFincvir(scrn,"OLHELP","USCNNOT","",0);
		...
		scrn->desc=stralloc("RDAScrolledList for User Identifications on the USCNNOT Master.");
		scrn->timing=0;
...
void USER_SCREEN_NOTES_BROWSE()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;

	scrn=RDAscrnNEW("OLHELP","USER SCREEN NOTES BROWSE");
	if(scrn!=NULL)
	{
...
void USER_SCREEN_NOTES_DEFINE_LIST()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;

	scrn=RDAscrnNEW("OLHELP","USER SCREEN NOTES DEFINE LIST");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
...
void USER_SCREEN_NOTES_MAINTAIN_SCREEN()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;

	scrn=RDAscrnNEW("OLHELP","USER SCREEN NOTES MAINTAIN SCREEN");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"[USCNNOT][DELETEFLAG]","Delete this record","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Module name:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,6,"PREVIOUS USCNNOT KEY","Previous Key","","",0,0,2,"","","","");
		ADVaddwdgt(scrn,0,"[USCNNOT][MODULE NAME]","Module Name","","",0,15,0,"","","","");
		ADVaddwdgt(scrn,6,"NEXT USCNNOT KEY","Next Key","","",0,0,1,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Screen name:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[USCNNOT][SCREEN NAME]","Screen Name","","",0,60,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","User Identification:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,7,"USCNNOT USER IDENTIFICATIONS","User Identifications","","",1,0,0,"","","","");
		ADVaddwdgt(scrn,0,"[USERS][USER NAME]","User Name","","",0,30,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","Notes:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,8,"[USCNNOT][NOTES]","Notes","","",10,80,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
...
void USER_SCREEN_NOTES_SEARCH_BROWSE()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;

	scrn=RDAscrnNEW("OLHELP","USER SCREEN NOTES SEARCH BROWSE");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"RANGE ON [USCNNOT][MODULE NAME]","Range on Module Name","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","From:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"FROM [USCNNOT][MODULE NAME]","From Module Name","","",0,15,0,"","","","");
		ADVaddwdgt(scrn,5,"","To:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"TO [USCNNOT][MODULE NAME]","To Module Name","","",0,15,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"RANGE ON [USCNNOT][SCREEN NAME]","Range on Screen Name","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","From:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"FROM [USCNNOT][SCREEN NAME]","From Screen Name","","",0,30,0,"","","","");
		ADVaddwdgt(scrn,5,"","To:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"TO [USCNNOT][SCREEN NAME]","To Screen Name","","",0,30,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"RANGE ON [USCNNOT][USER IDENTIFICATION]","Range on User Identification","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,5,"","From:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"FROM [USCNNOT][USER IDENTIFICATION]","From User Identification","","",0,15,0,"","","","");
		ADVaddwdgt(scrn,5,"","To:","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,0,"TO [USCNNOT][USER IDENTIFICATION]","To User Identification","","",0,15,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,3,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"SELECT [USCNNOT][DELETEFLAG] FALSE","Select non-deleted records","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,9,"SELECT [USCNNOT][DELETEFLAG] TRUE","Select deleted records","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,4,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,2,"","","","",0,0,0,"","","","");
		ADVaddwdgt(scrn,1,"","","","",0,0,0,"","","","");
...
static void SCN_USER_SCREEN_NOTES_BROWSE()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	...
	if(scrn!=NULL)
	{
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [OLHELP] Screen [USER SCREEN NOTES BROWSE], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
...
static void DEF_USER_SCREEN_NOTES_DEFINE_LIST()
{
	RDAdefault *def=NULL;
	char *defdir=NULL;
	char *temp1=NULL;

	def=RDAdefaultNEW("OLHELP","USER SCREEN NOTES DEFINE LIST");
	if(def!=NULL)
	{
		...
		addDefaultFieldSHORT(def,"USER IDENTIFICATION POSITION",TRUE,7,3);
		...
		{
			if(temp1!=NULL) Rfree(temp1);
			temp1=Rmalloc(29+6+100+1);
			sprintf(temp1,"SCREEN DEFAULT WRITE ERROR: Module [OLHELP] Screen [USER SCREEN NOTES DEFINE LIST], Can Not Save Screen Defaults!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
{
	MTN_USCNNOT();
	USCNNOT_USER_IDENTIFICATIONS();
	USER_SCREEN_NOTES_SEARCH_BROWSE();
	USER_SCREEN_NOTES_MAINTAIN_SCREEN();
	USER_SCREEN_NOTES_DEFINE_LIST();
	DEF_USER_SCREEN_NOTES_DEFINE_LIST();
	USER_SCREEN_NOTES_BROWSE();
	SCN_USER_SCREEN_NOTES_BROWSE();
}
