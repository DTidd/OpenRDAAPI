...
#endif
{
	...
	if(mainrsrc->scn!=NULL)
	{
		...
		ADVaddwdgt(mainrsrc->scn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,5,"","\"Installed\" is the last date a complete update","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,5,"","to this application was performed","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,5,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,5,"","\"Compiled\" was the date the application update","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,5,"","program was created at OpenRDA.","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,5,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,5,"","\"Released\" is the date programs were made.","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,5,"","available for download from the website.","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		ADVaddwdgt(mainrsrc->scn,12,"","","","",300,535,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(mainrsrc->scn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
