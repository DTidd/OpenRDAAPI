...
extern char AT_LEAST_ONE_WINDOW;
extern FILE *cssNames;
...
void makefield(Wt::WWidget *,RDArmem *,char *,char *,char *,short,short,int,Wt::WTable *,int,int,int,int);
...
char *ModuleScreenStyleClass(RDArsrc *);
char *RemoveSpaces(char *);
char *InputFieldStyleClass(RDArmem *);
char *ScreenStyleClass(RDArsrc *);
