...
#define USING_WT
#define numRDAColorProfiles	7
extern Wt::WWidget *QN2IT_PARENT;
extern short QN2IT_PARENT_TYPE;
extern int currentRDAColorProfile;
...
extern Wt::WServer *RDA_svr;
extern std::string RDA_Session;
extern Wt::WCssStyleSheet *RDAStyle;
...
#define IsScreenDisplayed(x)	(x->swidget!=NULL)
...
extern void (*CustomTableFunction)(...);
