/* ARCHIVE's - Make (MTN ARCHUSER) Maintain Master */
#include <cstdio>
#include <mkmtn.hpp>
#include <mkmsc.hpp>
#include <mkdef.hpp>
...
static void MTN_MTN_ARCHUSER()
{
	...
	MTNMSTR=RDAMaintainMasterNEW(module,"MTN ARCHUSER",temp1,1,"ARCHUSER","ARCHUSER BROWSE","ARCHUSER DEFINE LIST","ARCHUSER SEARCH BROWSE","ARCHUSER MAINTAIN SCREEN",0,1,0,0,temp2,temp3,temp5,temp4,temp6,FALSE,FALSE,FALSE,"");
...
/* ARCHIVE ARCHWORK */
		...
		r=addMaintainMasterSupportingADV(MTNMSTR,"ARCHIVE","ARCHWORK",0,0,NULL,"ARCHWORK KEY 1",temp1,TRUE,"LOAD WORK GROUP","SELECT WORK GROUP BROWSE","SELECT WORK GROUP DEFINE LIST","SELECT WORK GROUP SEARCH BROWSE",0,"ARCHIVE","ARCHUSER");
		if(temp1!=NULL) Rfree(temp1);
		if(r>0)
		{
			S=MTNMSTR->s+(r-1);
			addSupportingRDAconfld(S,"WORK GROUP","[ARCHUSER][WORK GROUP]",FALSE);
		}
...
/* SECURITY USERS */
		...
		r=addMaintainMasterSupportingADV(MTNMSTR,"SECURITY","USERS",0,0,NULL,"USERS KEY",temp1,TRUE,"LOAD USERS","SELECT USER IDENTIFICATION BROWSE","SELECT USER IDENTIFICATION DEFINE LIST","SELECT USER IDENTIFICATION SEARCH BROWSE",1,"ARCHIVE","ARCHUSER");
		if(temp1!=NULL) Rfree(temp1);
		if(r>0)
		{
			S=MTNMSTR->s+(r-1);
			addSupportingRDAconfld(S,"USER IDENTIFICATION","[ARCHUSER][USER IDENTIFICATION]",FALSE);
		}
...
/* SUPPORTING FILES Ending */
		...
		if(writeMaintainMaster(defdir,MTNMSTR))
		{
			...
			sprintf(temp1,"MAINTAIN MASTER WRITE ERROR: Module [ARCHIVE] Maintain Master [MTN ARCHUSER], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
...
static void MNU_ARCHIVE_MTN_ARCHUSER()
{
	RDAmenu *menu=NULL;
	char *defdir=NULL;

	menu=RDAmenuNEW("ARCHIVE MTN ARCHUSER","mtnmst.EXT ARCHIVE \"MTN ARCHUSER\"");
	if(menu!=NULL)
	{
...
static void SCN_ARCHUSER_BROWSE()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("ARCHIVE","ARCHUSER BROWSE");
	if(scrn!=NULL)
	{
		temp1=Rmalloc(23+1);
		sprintf(temp1,"%s",
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [ARCHIVE] Screen [ARCHUSER BROWSE], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void SCN_ARCHUSER_DEFINE_LIST()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("ARCHIVE","ARCHUSER DEFINE LIST");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Read:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Write:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,4,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,3,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		ADVaddwdgt(scrn,3,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"READ POSITION","Read Position","","",0,3,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"READ LENGTH","Read Length","","",0,3,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,4,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		ADVaddwdgt(scrn,3,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"WRITE POSITION","Write Position","","",0,3,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"WRITE LENGTH","Write Length","","",0,3,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,4,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,4,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [ARCHIVE] Screen [ARCHUSER DEFINE LIST], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void SCN_ARCHUSER_MAINTAIN_SCREEN()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("ARCHIVE","ARCHUSER MAINTAIN SCREEN");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,9,"[ARCHUSER][DELETEFLAG]","Delete this record","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","         Work Group:","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"LOAD WORK GROUP","Load Work Group","","",0,0,1,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"PREVIOUS LOAD WORK GROUP","Previous Load Work Group","","",0,0,2,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"[ARCHUSER][WORK GROUP]","Work Group:","","",0,15,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"NEXT LOAD WORK GROUP","Next Load Work Group","","",0,0,1,NULL,NULL,NULL,NULL);
		...
		ADVaddwdgt(scrn,6,"PREVIOUS ARCHUSER KEY 1","Previous","","",0,0,2,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,0,"[ARCHUSER][USER IDENTIFICATION]","User Identification:","","",0,15,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"NEXT ARCHUSER KEY 1","Next","","",0,0,1,NULL,NULL,NULL,NULL);
		...
		ADVaddwdgt(scrn,3,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,9,"[ARCHUSER][READ]","Read","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,9,"[ARCHUSER][WRITE]","Write","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,4,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		/*
		ADVaddwdgt(scrn,6,"SAVE","Save","","",0,0,54,NULL,NULL,"([LOGIN IDENTIFICATION]=[ARCHIVE][ARCHWORK][USER IDENTIFICATION])",NULL);
		ADVaddwdgt(scrn,6,"SAVE NO UPDATE","Fast Save","","",0,0,23,NULL,NULL,"([LOGIN IDENTIFICATION]=[ARCHIVE][ARCHWORK][USER IDENTIFICATION])",NULL);
		*/
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [ARCHIVE] Screen [ARCHUSER MAINTAIN SCREEN], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void SCN_ARCHUSER_SEARCH_BROWSE()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("ARCHIVE","ARCHUSER SEARCH BROWSE");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,3,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,9,"SELECT [ARCHUSER][DELETEFLAG] FALSE","Select when Deleteflag False","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,9,"SELECT [ARCHUSER][DELETEFLAG] TRUE","Select when Deleteflag True","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		ADVaddwdgt(scrn,14,"ARCHUSER SEARCH BROWSE EXPRESSION","Expression","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [ARCHIVE] Screen [ARCHUSER SEARCH BROWSE], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void SCN_ARCHUSER_SEARCH_BROWSE_EXPRESSION()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("ARCHIVE","ARCHUSER SEARCH BROWSE EXPRESSION");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [ARCHIVE] Screen [ARCHUSER SEARCH BROWSE EXPRESSION], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void SCN_SELECT_WORK_GROUP_BROWSE()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("ARCHIVE","SELECT WORK GROUP BROWSE");
	if(scrn!=NULL)
	{
		temp1=Rmalloc(23+1);
		sprintf(temp1,"%s",
		...
		if(writescrnbin(defdir,scrn))
		{
			if(temp1!=NULL) Rfree(temp1);
			temp1=Rmalloc(24+7+89+1);
			sprintf(temp1,"SCREEN WRITE ERROR: Module [ARCHIVE] Screen [SELECT WORK GROUP BROWSE], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void SCN_SELECT_WORK_GROUP_DEFINE_LIST()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("ARCHIVE","SELECT WORK GROUP DEFINE LIST");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","Enter a position and length for each of the following:","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [ARCHIVE] Screen [SELECT WORK GROUP DEFINE LIST], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void SCN_SELECT_WORK_GROUP_SEARCH_BROWSE()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("ARCHIVE","SELECT WORK GROUP SEARCH BROWSE");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,3,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		ADVaddwdgt(scrn,6,"QUIT","Cancel","","",0,0,14,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,14,"SELECT WORK GROUP SEARCH BROWSE EXPRESSION","Expression","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"HELP","Help","","",0,0,11,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,6,"DEFAULTS","Save Defaults","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,2,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,4,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		if(writescrnbin(defdir,scrn))
		{
			...
			sprintf(temp1,"SCREEN WRITE ERROR: Module [ARCHIVE] Screen [SELECT WORK GROUP SEARCH BROWSE], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void SCN_SELECT_WORK_GROUP_SEARCH_BROWSE_EXPRESSION()
{
	RDAscrn *scrn=NULL;
	char *defdir=NULL;
	char *temp1=NULL,*temp2=NULL;
	...
	scrn=RDAscrnNEW("ARCHIVE","SELECT WORK GROUP SEARCH BROWSE EXPRESSION");
	if(scrn!=NULL)
	{
		ADVaddwdgt(scrn,1,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		ADVaddwdgt(scrn,5,"","","","",0,0,0,NULL,NULL,NULL,NULL);
		...
		{
			if(temp1!=NULL) Rfree(temp1);
			temp1=Rmalloc(42+7+89+1);
			sprintf(temp1,"SCREEN WRITE ERROR: Module [ARCHIVE] Screen [SELECT WORK GROUP SEARCH BROWSE EXPRESSION], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void DEF_ARCHUSER_DEFINE_LIST()
{
	RDAdefault *def=NULL;
	char *defdir=NULL;
	char *temp1=NULL;

	def=RDAdefaultNEW("ARCHIVE","ARCHUSER DEFINE LIST");
	if(def!=NULL)
	{
		...
		addDefaultFieldSHORT(def,"READ POSITION",TRUE,7,3);
		addDefaultFieldSHORT(def,"READ LENGTH",TRUE,7,1);
		addDefaultFieldSHORT(def,"WRITE POSITION",TRUE,7,4);
		addDefaultFieldSHORT(def,"WRITE LENGTH",TRUE,7,1);
		...
		if(writedefaultbin(defdir,def))
		{
			...
			sprintf(temp1,"SCREEN DEFAULT WRITE ERROR: Module [ARCHIVE] Screen [ARCHUSER DEFINE LIST], Can Not Save Screen Defaults!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
static void MTN_MTN_ARCHUSER_SEARCH()
{
	char *defdir=NULL;
	RDAsearch *S=NULL;
	short r=0;
	...
	MTNMSTR=RDAMaintainMasterNEW(module,"MTN ARCHUSER.SEARCH",temp1,1,"ARCHUSER","ARCHUSER BROWSE","ARCHUSER DEFINE LIST","ARCHUSER SEARCH BROWSE","ARCHUSER MAINTAIN SCREEN",0,2,0,0,temp2,temp3,temp5,temp4,temp6,FALSE,FALSE,FALSE,"");
	if(temp1!=NULL) Rfree(temp1);
	if(temp2!=NULL) Rfree(temp2);
	if(temp3!=NULL) Rfree(temp3);
	if(temp4!=NULL) Rfree(temp4);
...
/* SUPPORTING FILES Ending */
		...
		if(writeMaintainMaster(defdir,MTNMSTR))
		{
			...
			sprintf(temp1,"MAINTAIN MTNMASTER WRITE ERROR: Module [ARCHIVE] Maintain Master [MTN ARCHUSER.SEARCH], Can Not Save Maintain Master!");
			prterr(temp1);
			if(errorlist!=NULL)
			{
				addERRlist(&errorlist,temp1);
...
{
	MTN_MTN_ARCHUSER();
	MNU_ARCHIVE_MTN_ARCHUSER();
	SCN_ARCHUSER_BROWSE();
	SCN_ARCHUSER_DEFINE_LIST();
	SCN_ARCHUSER_MAINTAIN_SCREEN();
	SCN_ARCHUSER_SEARCH_BROWSE();
	SCN_ARCHUSER_SEARCH_BROWSE_EXPRESSION();
	SCN_SELECT_WORK_GROUP_BROWSE();
	SCN_SELECT_WORK_GROUP_DEFINE_LIST();
	SCN_SELECT_WORK_GROUP_SEARCH_BROWSE();
	SCN_SELECT_WORK_GROUP_SEARCH_BROWSE_EXPRESSION();
	DEF_ARCHUSER_DEFINE_LIST();
	MTN_MTN_ARCHUSER_SEARCH();
}
