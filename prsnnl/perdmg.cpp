/* perdmg.c - Personnel Demographics Master Program */
/*lint -library */
#ifndef WIN32
#define __NAM__ "perdmg.lnx"
#endif
#ifdef WIN32
#define __NAM__ "perdmg.exe"
#endif
#include <app.h>
#include <rdaglob.h>
#include <rdaflds.h>
...
extern void perdmgm(short,void *);
static void doexit(MakeBrowseList *),okfunc(MakeBrowseList *,void *);
static void new_record(RDArsrc *,MakeBrowseList *);
char editable=TRUE;
MakeBrowseList *mbl_perdmg=NULL;
MaintainMaster *MASTER=NULL;
void browse_perdmg(RDArsrc *,RDATData *);

void browse_perdmg(RDArsrc *mtnrsrc,RDATData *previous)
{
	...
	MakeMasterButtons(mainrsrc,MASTER);
	mbl_perdmg=ADVPbrowse(MASTER->passkey->fileno,MASTER->passkey->keyno,
...
void main(int argc,char **argv)
{
	...
	if(findMaintainMaster(MASTER))
	{
		...
		if((filenum=APPOPNNRDEDITABLE(MASTER->module,"PERDMG",&editable))==(-1))
		{
			doexit(NULL);
			return;
		}
...
void doexit(MakeBrowseList *blist)
{
	...
	if(mbl_perdmg!=NULL) mbl_perdmg=NULL;
}
