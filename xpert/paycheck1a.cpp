/* paycheck1.c - Archive Payroll Checks */
...
******************************************/
#ifndef WIN32
#define __NAM__ "paycheck1a.lnx"
#endif
#ifdef WIN32
#define __NAM__ "paycheck1a.exe"
#endif
#include <app.hpp>
#include <mix.hpp>
#include <fin.hpp>
...
static char top_feeder=FALSE,use_sign_locks=FALSE;
...
static void printactualcheck()
{
	...
	fprintf(fp,"%-11s %-35s %-10s %-10s %-10s\r\n",(ssn!=NULL ? ssn:""),
...
/* (payending!=NULL ? payending:""),CURRENT_DATE10); */
	...
	fprintf(fp,"\r\n");
	fprintf(fp,"\r\n");
	fprintf(fp,"      %6.02f %8.02f %8.02f %5.02f %7.02f ",reg_units,
...
/* voluntary deductions */
	if(!isEMPTY(title1))
	{
		fprintf(fp,"%-8s ",title1);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title2))
	{
		fprintf(fp,"%-8s ",title2);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title3))
	{
		fprintf(fp,"%-8s ",title3);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title4))
	{
		fprintf(fp,"%-8s ",title4);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title5))
	{
		fprintf(fp,"%-8s ",title5);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title6))
	{
		fprintf(fp,"%-8s ",title6);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title7))
	{
		fprintf(fp,"%-8s ",title7);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title8))
	{
		fprintf(fp,"%-8s ",title8);
	} else fprintf(fp,"%-8s ","");
	fprintf(fp," \r\n");

	if(!isEMPTY(title1))
	{
		fprintf(fp,"%8.02f ",vol1/100);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title2))
	{
		fprintf(fp,"%8.02f ",vol2/100);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title3))
	{
		fprintf(fp,"%8.02f ",vol3/100);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title4))
	{
		fprintf(fp,"%8.02f ",vol4/100);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title5))
	{
		fprintf(fp,"%8.02f ",vol5/100);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title6))
	{
		fprintf(fp,"%8.02f ",vol6/100);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title7))
	{
		fprintf(fp,"%8.02f ",vol7/100);
	} else fprintf(fp,"%-8s ","");
	if(!isEMPTY(title8))
	{
		fprintf(fp,"%8.02f ",vol8/100);
	} else fprintf(fp,"%-8s ","");
	fprintf(fp,"%8.02f",(vol1+vol2+vol3+vol4+vol5+vol6+vol7+vol8)/100);
	fprintf(fp,"\r\n");
	fprintf(fp,"\r\n");
	fprintf(fp,"\r\n");
	...
	fprintf(fp,"      %7.02f %7.02f%12s %8.02f %8.02f %8.02f %7.02f    %8.02f\r\n",
...
if(!outoforder)
{
	if((XPERT_SETUP->LVEMGT==TRUE || XPERT_SETUP->LVSIMP==TRUE) && skip_leave==FALSE)
	{
		if(check_type==3)
		{
			fprintf(fp,"      %9.02f %9.02f %8.02f %10.02f %6.02f %6.02f %9s %10.02f\r\n",
				fed_ytd/100,(fica_ytd+med_ytd)/100,state_ytd/100,
				total_gross_ytd/100,vacb,sickb,"",net/100);
		} else if(check_type==4)
		{
			fprintf(fp,"      %9.02f %9.02f %8.02f %10.02f %6.02f %6.02f %6.02f %2s %10.02f\r\n",
				fed_ytd/100,(fica_ytd+med_ytd)/100,state_ytd/100,
				total_gross_ytd/100,vacb,sickb,perb,"",net/100);
		} else if(check_type==5)
		{
			fprintf(fp,"   %9.02f %9.02f %8.02f %10.02f %6.02f %6.02f %8.02f %3s %10.02f\r\n",
				fed_ytd/100,(fica_ytd+med_ytd)/100,state_ytd/100,
				total_gross_ytd/100,vacb,sickb,local_ytd/100,"",
				net/100);
		} else {
			fprintf(fp,"   %9.02f %9.02f %8.02f %10.02f %6.02f %6.02f %6.02f %5s %10.02f\r\n",
				fed_ytd/100,(fica_ytd+med_ytd)/100,state_ytd/100,
				total_gross_ytd/100,vacb,sickb,perb,"",net/100);
		}
	} else {
		if((check_type==3) || (check_type==4))
		{
			fprintf(fp,"      %9.02f %9.02f %8.02f %10.02f %23s %10.02f\r\n",
				fed_ytd/100,(fica_ytd+med_ytd)/100,state_ytd/100,
				total_gross_ytd/100,"",net/100);
		} else if(check_type==5)
		{

			fprintf(fp,"   %9.02f %9.02f %8.02f %10.02f %13s %8.02f %3s %10.02f\r\n",
				fed_ytd/100,(fica_ytd+med_ytd)/100,state_ytd/100,
				total_gross_ytd/100,"",local_ytd/100,"",net/100);
		} else {
			fprintf(fp,"   %9.02f %9.02f %8.02f %10.02f %26s %10.02f\r\n",
				fed_ytd/100,(fica_ytd+med_ytd)/100,state_ytd/100,
				total_gross_ytd/100,"",net/100);
		}
	}
	...
	if((XPERT_SETUP->LVEMGT==TRUE || XPERT_SETUP->LVSIMP==TRUE) && skip_leave==FALSE)
	{
		if(check_type==3)
		{
			fprintf(fp,"      %15s %3s %8s %10s %6.02f %6.02f %9s %10.02f\r\n",
				"HISTORY UPDATED","","","",vacb,sickb,"",net/100);
		} else if(check_type==4)
		{
			fprintf(fp,"   %15s %3s %8s %10s %6.02f %6.02f %6.02f %5s %10.02f\r\n",
				"HISTORY UPDATED","","","",vacb,sickb,perb,"",net/100);
		} else if(check_type==5)
		{
			fprintf(fp,"   %15s %3s %8s %10s %6.02f %6.02f %8.02f %3s %10.02f\r\n",
		...
		if((check_type==3))
		{
			fprintf(fp,"      %15s %3s %8s %10s %23s %10.02f\r\n",
				"HISTORY UPDATED","","","","",net/100);
		} else if((check_type==4))
		{
			fprintf(fp,"   %15s %3s %8s %10s %26s %10.02f\r\n",
				"HISTORY UPDATED","","","","",net/100);
		} else if(check_type==5)
		{

			fprintf(fp,"   %15s %3s %8s %10s %13s %8s %3s %10.02f\r\n",
				"HISTORY UPDATED","","","","","","",net/100);
		} else {
			fprintf(fp,"   %15s %3s %8s %10s %26s %10.02f\r\n",
				"HISTORY UPDATED","","","","",net/100);
...
#endif
{
	...
	if(InitializeSubsystems(argc,argv,module,"ARCHIVE PAYROLL CHECKS")) 
	{
		RDAAPPMAINLOOP();
		return;
	}
	...
	mainrsrc=RDArsrcNEW(module,"ARCHIVE PAYROLL CHECKS");
