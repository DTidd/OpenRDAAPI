...
#ifndef WIN32
#define __NAM__ "payvwcheckds.lnx"
#endif
#ifdef WIN32
#define __NAM__ "payvwcheckds.exe"
#endif
#include <app.hpp>
...
char check_formfeed=FALSE,top_feeder=FALSE,use_check_offset=FALSE;
/*
short spelledamtpos=0;
char *module="PAYROLL",*output_device=NULL;
*/
char *bank_id=NULL,use_high_amount=FALSE;
static char *defbankid=NULL;
short vennum=(-1),payddsv=(-1),ddsnum=(-1);
short banknum=(-1),venadr=(-1),high_amount=0;
