...
#ifndef WIN32
#define __NAM__ "dirdep.lnx"
#endif
#ifdef WIN32
#define __NAM__ "dirdep.exe"
#endif
#include <app.hpp>
#include <mix.hpp>
#include <fin.hpp>
...
/*
static void payResetGroupDefaults(RDArsrc *r)
{
...
/* Key Info */
	...
	{	
		...
		//addrfcbrsrc(rsrc,"RESET GROUP DEFAULTS",TRUE,payResetGroupDefaults,NULL);
		addrfcbrsrc(rsrc,"RESET GROUP DEFAULTS",TRUE,ResetGroupDefaults,NULL);
...
#endif
{
	...
	mainrsrc=RDArsrcNEW(module,"PRINT DIRECT DEPOSIT 8.5x11");
	...
	//addbtnrsrc(mainrsrc,"RESET GROUP DEFAULTS",TRUE,payResetGroupDefaults,NULL);
